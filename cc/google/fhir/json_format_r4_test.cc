...
using namespace google::fhir::r4::proto;  // NOLINT
...
void TestPrint(const string& name) {
  ...
  ASSERT_TRUE(from_proto_status.ok()) << "Failed Printing on: " << name;
...
TEST(JsonFormatR4Test, TestBasic) {
  std::vector<string> files{"Basic-basic-example-narrative",
...
TEST(JsonFormatR4Test, TestComposition) {
  std::vector<string> files{"Composition-example",
...
TEST(JsonFormatR4Test, TestEndpoint) {
  std::vector<string> files{"Endpoint-direct-endpoint",
...
TEST(JsonFormatR4Test, TestImagingStudy) {
  std::vector<string> files{"ImagingStudy-example",
...
TEST(JsonFormatR4Test, TestLocation) {
  std::vector<string> files{"Location-1",   "Location-2",
                                  "Location-amb", "Location-hl7",
                                  "Location-ph",  "Location-ukp"};
...
TEST(JsonFormatR4Test, TestNamingSystem) {
  std::vector<string> files{"NamingSystem-example-id",
...
TEST(JsonFormatR4Test, TestPerson) {
  std::vector<string> files{"Person-example", "Person-f002",
