...
TEST(BundleToVersionedResourcesConverterTest, TimestampOverrideSet) {
  Bundle input;
  ASSERT_TRUE(google::protobuf::TextFormat::ParseFromString(R"proto(
    entry {
      resource {
        encounter {
          ...
          location {
            location { location_id { value: "Tatooine" } }
            period {
              start { value_us: 5 }
              end { value_us: 7 }
            }
          ...
          location {
            location { location_id { value: "Taco Bell" } }
            period {
              start { value_us: 8 }
              end { value_us: 10 }
            }
          ...
          hospitalization {
            discharge_disposition { text { value: "beligerant" } }
            re_admission { text { value: "probable" } }
          }
          incoming_referral { display { value: "reluctant" } }
        }
      }
    })proto", &input));
  ...
  ASSERT_TRUE(google::protobuf::TextFormat::ParseFromString(R"proto(
    encounter {
      ...
      hospitalization { re_admission { text { value: "probable" } } }
      incoming_referral { display { value: "reluctant" } }
      meta {
        version_id { value: "0" }
        last_updated {
...
TEST(BundleToVersionedResourcesConverterTest, TimestampOverrideEmpty) {
  Bundle input;
  ASSERT_TRUE(google::protobuf::TextFormat::ParseFromString(R"proto(
    entry {
      resource {
...
TEST(BundleToVersionedResourcesConverterTest, TimestampOverrideDefaultEmpty) {
  Bundle input;
  ASSERT_TRUE(google::protobuf::TextFormat::ParseFromString(R"proto(
    entry {
      resource {
        encounter {
          period { end { value_us: 10 } }
          location {
            location { location_id { value: "Tatooine" } }
            period {
              start { value_us: 5 }
