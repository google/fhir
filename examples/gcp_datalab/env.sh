...
export hivebucketname=$clustername"-hive-bkt" #Unique sqlhive bucketname please note: this bucket is created once
export hivedbname=$clustername"-hive-db" #Set the database name
