...
// 	protoc        v3.21.12
// source: proto/google/fhir/proto/r5/core/resources/linkage.proto
...
func (x *Linkage) Reset() {
	*x = Linkage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes[0]
...
func (*Linkage) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescGZIP(), []int{0}
}
...
func (x *Linkage_Item) Reset() {
	*x = Linkage_Item{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Linkage_Item) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Linkage_Item_TypeCode) Reset() {
	*x = Linkage_Item_TypeCode{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Linkage_Item_TypeCode) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
var file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDesc = []byte{
	...
	0x68, 0x69, 0x72, 0x2e, 0x72, 0x35, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x4c, 0x69, 0x6e, 0x6b,
	...
	0x07, 0x10, 0x08, 0x42, 0x77, 0x98, 0xc6, 0xb0, 0xb5, 0x07, 0x05, 0x0a, 0x17, 0x63, 0x6f, 0x6d,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x35, 0x2e,
...
var (
	file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescOnce sync.Once
	file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescData = file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDesc
)

func file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescGZIP() []byte {
	file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescOnce.Do(func() {
		file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescData)
	})
	return file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDescData
}

var file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_google_fhir_proto_r5_core_resources_linkage_proto_goTypes = []interface{}{
	(*Linkage)(nil),                           // 0: google.fhir.r5.core.Linkage
	(*Linkage_Item)(nil),                      // 1: google.fhir.r5.core.Linkage.Item
	(*Linkage_Item_TypeCode)(nil),             // 2: google.fhir.r5.core.Linkage.Item.TypeCode
	...
	(codes_go_proto.LinkageTypeCode_Value)(0), // 13: google.fhir.r5.core.LinkageTypeCode.Value
}
var file_proto_google_fhir_proto_r5_core_resources_linkage_proto_depIdxs = []int32{
	3,  // 0: google.fhir.r5.core.Linkage.id:type_name -> google.fhir.r5.core.Id
	4,  // 1: google.fhir.r5.core.Linkage.meta:type_name -> google.fhir.r5.core.Meta
	5,  // 2: google.fhir.r5.core.Linkage.implicit_rules:type_name -> google.fhir.r5.core.Uri
	6,  // 3: google.fhir.r5.core.Linkage.language:type_name -> google.fhir.r5.core.Code
	7,  // 4: google.fhir.r5.core.Linkage.text:type_name -> google.fhir.r5.core.Narrative
	8,  // 5: google.fhir.r5.core.Linkage.contained:type_name -> google.protobuf.Any
	9,  // 6: google.fhir.r5.core.Linkage.extension:type_name -> google.fhir.r5.core.Extension
	9,  // 7: google.fhir.r5.core.Linkage.modifier_extension:type_name -> google.fhir.r5.core.Extension
	10, // 8: google.fhir.r5.core.Linkage.active:type_name -> google.fhir.r5.core.Boolean
	11, // 9: google.fhir.r5.core.Linkage.author:type_name -> google.fhir.r5.core.Reference
	1,  // 10: google.fhir.r5.core.Linkage.item:type_name -> google.fhir.r5.core.Linkage.Item
	12, // 11: google.fhir.r5.core.Linkage.Item.id:type_name -> google.fhir.r5.core.String
	9,  // 12: google.fhir.r5.core.Linkage.Item.extension:type_name -> google.fhir.r5.core.Extension
	9,  // 13: google.fhir.r5.core.Linkage.Item.modifier_extension:type_name -> google.fhir.r5.core.Extension
	2,  // 14: google.fhir.r5.core.Linkage.Item.type:type_name -> google.fhir.r5.core.Linkage.Item.TypeCode
	11, // 15: google.fhir.r5.core.Linkage.Item.resource:type_name -> google.fhir.r5.core.Reference
	13, // 16: google.fhir.r5.core.Linkage.Item.TypeCode.value:type_name -> google.fhir.r5.core.LinkageTypeCode.Value
	12, // 17: google.fhir.r5.core.Linkage.Item.TypeCode.id:type_name -> google.fhir.r5.core.String
	9,  // 18: google.fhir.r5.core.Linkage.Item.TypeCode.extension:type_name -> google.fhir.r5.core.Extension
...
func init() { file_proto_google_fhir_proto_r5_core_resources_linkage_proto_init() }
func file_proto_google_fhir_proto_r5_core_resources_linkage_proto_init() {
	if File_proto_google_fhir_proto_r5_core_resources_linkage_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_google_fhir_proto_r5_core_resources_linkage_proto_goTypes,
		DependencyIndexes: file_proto_google_fhir_proto_r5_core_resources_linkage_proto_depIdxs,
		MessageInfos:      file_proto_google_fhir_proto_r5_core_resources_linkage_proto_msgTypes,
	}.Build()
	File_proto_google_fhir_proto_r5_core_resources_linkage_proto = out.File
	file_proto_google_fhir_proto_r5_core_resources_linkage_proto_rawDesc = nil
	file_proto_google_fhir_proto_r5_core_resources_linkage_proto_goTypes = nil
	file_proto_google_fhir_proto_r5_core_resources_linkage_proto_depIdxs = nil
}
