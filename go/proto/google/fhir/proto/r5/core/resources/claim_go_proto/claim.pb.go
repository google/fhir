...
type Claim_Item struct {
	...
	BodySite []*Claim_Item_BodySite          `protobuf:"bytes,21,rep,name=body_site,json=bodySite,proto3" json:"body_site,omitempty"`
	// Encounters associated with the listed treatments
...
var file_proto_google_fhir_proto_r5_core_resources_claim_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x15, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
