...
type MeasureReport_Group struct {
	...
	MeasureScore *MeasureReport_Group_MeasureScoreX `protobuf:"bytes,6,opt,name=measure_score,json=measureScore,proto3" json:"measure_score,omitempty"`
...
type MeasureReport_Group_Stratifier_StratifierGroup_Component struct {
	...
	Code  *datatypes_go_proto.CodeableConcept                              `protobuf:"bytes,4,opt,name=code,proto3" json:"code,omitempty"`
	Value *MeasureReport_Group_Stratifier_StratifierGroup_Component_ValueX `protobuf:"bytes,5,opt,name=value,proto3" json:"value,omitempty"`
}
...
var file_proto_google_fhir_proto_r5_core_resources_measure_report_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x65, 0x12, 0x72, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05, 0x20, 0x01,
