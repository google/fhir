...
// 	protoc        v3.21.12
// source: proto/google/fhir/proto/r5/core/resources/related_person.proto
...
// 2019-12-31T21:03:40.621+11:00. A person that is related to a patient, but who
...
func (x *RelatedPerson) Reset() {
	*x = RelatedPerson{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes[0]
...
func (*RelatedPerson) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescGZIP(), []int{0}
}
...
func (x *RelatedPerson_GenderCode) Reset() {
	*x = RelatedPerson_GenderCode{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RelatedPerson_GenderCode) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *RelatedPerson_Communication) Reset() {
	*x = RelatedPerson_Communication{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RelatedPerson_Communication) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescGZIP(), []int{0, 1}
}

func (x *RelatedPerson_Communication) GetId() *datatypes_go_proto.Id {
	if x != nil {
		return x.Id
	}
	return nil
...
var File_proto_google_fhir_proto_r5_core_resources_related_person_proto protoreflect.FileDescriptor

var file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x0f, 0x0a, 0x0d, 0x52, 0x65,
	...
	0x72, 0x35, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x50,
	...
	0x2f, 0x63, 0x6f, 0x64, 0x65, 0x1a, 0xcb, 0x02, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x75, 0x6e,
	...
	0x72, 0x65, 0x64, 0x3a, 0x41, 0xc0, 0x9f, 0xe3, 0xb6, 0x05, 0x03, 0xb2, 0xfe, 0xe4, 0x97, 0x06,
	...
	0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x65, 0x64,
	0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x42, 0x7e, 0x0a, 0x17,
	...
	0x65, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x5f, 0x67, 0x6f,
	0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x98, 0xc6, 0xb0, 0xb5, 0x07, 0x05, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescOnce sync.Once
	file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescData = file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDesc
)

func file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescGZIP() []byte {
	file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescOnce.Do(func() {
		file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescData)
	})
	return file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDescData
}

var file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_google_fhir_proto_r5_core_resources_related_person_proto_goTypes = []interface{}{
	(*RelatedPerson)(nil),                              // 0: google.fhir.r5.core.RelatedPerson
	(*RelatedPerson_GenderCode)(nil),                   // 1: google.fhir.r5.core.RelatedPerson.GenderCode
	(*RelatedPerson_Communication)(nil),                // 2: google.fhir.r5.core.RelatedPerson.Communication
	...
	(codes_go_proto.AdministrativeGenderCode_Value)(0), // 20: google.fhir.r5.core.AdministrativeGenderCode.Value
	(*datatypes_go_proto.String)(nil),                  // 21: google.fhir.r5.core.String
}
var file_proto_google_fhir_proto_r5_core_resources_related_person_proto_depIdxs = []int32{
	3,  // 0: google.fhir.r5.core.RelatedPerson.id:type_name -> google.fhir.r5.core.Id
	4,  // 1: google.fhir.r5.core.RelatedPerson.meta:type_name -> google.fhir.r5.core.Meta
	5,  // 2: google.fhir.r5.core.RelatedPerson.implicit_rules:type_name -> google.fhir.r5.core.Uri
	6,  // 3: google.fhir.r5.core.RelatedPerson.language:type_name -> google.fhir.r5.core.Code
	7,  // 4: google.fhir.r5.core.RelatedPerson.text:type_name -> google.fhir.r5.core.Narrative
	8,  // 5: google.fhir.r5.core.RelatedPerson.contained:type_name -> google.protobuf.Any
	9,  // 6: google.fhir.r5.core.RelatedPerson.extension:type_name -> google.fhir.r5.core.Extension
	9,  // 7: google.fhir.r5.core.RelatedPerson.modifier_extension:type_name -> google.fhir.r5.core.Extension
	10, // 8: google.fhir.r5.core.RelatedPerson.identifier:type_name -> google.fhir.r5.core.Identifier
	11, // 9: google.fhir.r5.core.RelatedPerson.active:type_name -> google.fhir.r5.core.Boolean
	12, // 10: google.fhir.r5.core.RelatedPerson.patient:type_name -> google.fhir.r5.core.Reference
	13, // 11: google.fhir.r5.core.RelatedPerson.relationship:type_name -> google.fhir.r5.core.CodeableConcept
	14, // 12: google.fhir.r5.core.RelatedPerson.name:type_name -> google.fhir.r5.core.HumanName
	15, // 13: google.fhir.r5.core.RelatedPerson.telecom:type_name -> google.fhir.r5.core.ContactPoint
	1,  // 14: google.fhir.r5.core.RelatedPerson.gender:type_name -> google.fhir.r5.core.RelatedPerson.GenderCode
	16, // 15: google.fhir.r5.core.RelatedPerson.birth_date:type_name -> google.fhir.r5.core.Date
	17, // 16: google.fhir.r5.core.RelatedPerson.address:type_name -> google.fhir.r5.core.Address
	18, // 17: google.fhir.r5.core.RelatedPerson.photo:type_name -> google.fhir.r5.core.Attachment
	19, // 18: google.fhir.r5.core.RelatedPerson.period:type_name -> google.fhir.r5.core.Period
	2,  // 19: google.fhir.r5.core.RelatedPerson.communication:type_name -> google.fhir.r5.core.RelatedPerson.Communication
	20, // 20: google.fhir.r5.core.RelatedPerson.GenderCode.value:type_name -> google.fhir.r5.core.AdministrativeGenderCode.Value
	21, // 21: google.fhir.r5.core.RelatedPerson.GenderCode.id:type_name -> google.fhir.r5.core.String
	9,  // 22: google.fhir.r5.core.RelatedPerson.GenderCode.extension:type_name -> google.fhir.r5.core.Extension
	3,  // 23: google.fhir.r5.core.RelatedPerson.Communication.id:type_name -> google.fhir.r5.core.Id
	9,  // 24: google.fhir.r5.core.RelatedPerson.Communication.extension:type_name -> google.fhir.r5.core.Extension
	9,  // 25: google.fhir.r5.core.RelatedPerson.Communication.modifier_extension:type_name -> google.fhir.r5.core.Extension
	13, // 26: google.fhir.r5.core.RelatedPerson.Communication.language:type_name -> google.fhir.r5.core.CodeableConcept
	11, // 27: google.fhir.r5.core.RelatedPerson.Communication.preferred:type_name -> google.fhir.r5.core.Boolean
...
func init() { file_proto_google_fhir_proto_r5_core_resources_related_person_proto_init() }
func file_proto_google_fhir_proto_r5_core_resources_related_person_proto_init() {
	if File_proto_google_fhir_proto_r5_core_resources_related_person_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_google_fhir_proto_r5_core_resources_related_person_proto_goTypes,
		DependencyIndexes: file_proto_google_fhir_proto_r5_core_resources_related_person_proto_depIdxs,
		MessageInfos:      file_proto_google_fhir_proto_r5_core_resources_related_person_proto_msgTypes,
	}.Build()
	File_proto_google_fhir_proto_r5_core_resources_related_person_proto = out.File
	file_proto_google_fhir_proto_r5_core_resources_related_person_proto_rawDesc = nil
	file_proto_google_fhir_proto_r5_core_resources_related_person_proto_goTypes = nil
	file_proto_google_fhir_proto_r5_core_resources_related_person_proto_depIdxs = nil
}
