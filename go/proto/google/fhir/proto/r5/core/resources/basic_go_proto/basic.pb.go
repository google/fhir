...
// 	protoc        v3.21.12
// source: proto/google/fhir/proto/r5/core/resources/basic.proto
...
// 2019-12-31T21:03:40.621+11:00. Resource for non-supported content. See
...
func (x *Basic) Reset() {
	*x = Basic{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_basic_proto_msgTypes[0]
...
func (*Basic) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescGZIP(), []int{0}
}
...
var File_proto_google_fhir_proto_r5_core_resources_basic_proto protoreflect.FileDescriptor

var file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDesc = []byte{
	...
	0x35, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x44, 0x61, 0x74, 0x65, 0x52, 0x07, 0x63, 0x72, 0x65,
...
var (
	file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescOnce sync.Once
	file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescData = file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDesc
)

func file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescGZIP() []byte {
	file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescOnce.Do(func() {
		file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescData)
	})
	return file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDescData
}

var file_proto_google_fhir_proto_r5_core_resources_basic_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_google_fhir_proto_r5_core_resources_basic_proto_goTypes = []interface{}{
	(*Basic)(nil),                              // 0: google.fhir.r5.core.Basic
	...
	(*datatypes_go_proto.Date)(nil),            // 11: google.fhir.r5.core.Date
}
var file_proto_google_fhir_proto_r5_core_resources_basic_proto_depIdxs = []int32{
	1,  // 0: google.fhir.r5.core.Basic.id:type_name -> google.fhir.r5.core.Id
	2,  // 1: google.fhir.r5.core.Basic.meta:type_name -> google.fhir.r5.core.Meta
	3,  // 2: google.fhir.r5.core.Basic.implicit_rules:type_name -> google.fhir.r5.core.Uri
	4,  // 3: google.fhir.r5.core.Basic.language:type_name -> google.fhir.r5.core.Code
	5,  // 4: google.fhir.r5.core.Basic.text:type_name -> google.fhir.r5.core.Narrative
	6,  // 5: google.fhir.r5.core.Basic.contained:type_name -> google.protobuf.Any
	7,  // 6: google.fhir.r5.core.Basic.extension:type_name -> google.fhir.r5.core.Extension
	7,  // 7: google.fhir.r5.core.Basic.modifier_extension:type_name -> google.fhir.r5.core.Extension
	8,  // 8: google.fhir.r5.core.Basic.identifier:type_name -> google.fhir.r5.core.Identifier
	9,  // 9: google.fhir.r5.core.Basic.code:type_name -> google.fhir.r5.core.CodeableConcept
	10, // 10: google.fhir.r5.core.Basic.subject:type_name -> google.fhir.r5.core.Reference
	11, // 11: google.fhir.r5.core.Basic.created:type_name -> google.fhir.r5.core.Date
	10, // 12: google.fhir.r5.core.Basic.author:type_name -> google.fhir.r5.core.Reference
...
func init() { file_proto_google_fhir_proto_r5_core_resources_basic_proto_init() }
func file_proto_google_fhir_proto_r5_core_resources_basic_proto_init() {
	if File_proto_google_fhir_proto_r5_core_resources_basic_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_google_fhir_proto_r5_core_resources_basic_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Basic); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_google_fhir_proto_r5_core_resources_basic_proto_goTypes,
		DependencyIndexes: file_proto_google_fhir_proto_r5_core_resources_basic_proto_depIdxs,
		MessageInfos:      file_proto_google_fhir_proto_r5_core_resources_basic_proto_msgTypes,
	}.Build()
	File_proto_google_fhir_proto_r5_core_resources_basic_proto = out.File
	file_proto_google_fhir_proto_r5_core_resources_basic_proto_rawDesc = nil
	file_proto_google_fhir_proto_r5_core_resources_basic_proto_goTypes = nil
	file_proto_google_fhir_proto_r5_core_resources_basic_proto_depIdxs = nil
}
