...
type Account struct {
	...
	Diagnosis      []*Account_Diagnosis         `protobuf:"bytes,22,rep,name=diagnosis,proto3" json:"diagnosis,omitempty"`
	Procedure      []*Account_Procedure         `protobuf:"bytes,23,rep,name=procedure,proto3" json:"procedure,omitempty"`
	RelatedAccount []*Account_RelatedAccount    `protobuf:"bytes,24,rep,name=related_account,json=relatedAccount,proto3" json:"related_account,omitempty"`
	// The base or default currency
	Currency *datatypes_go_proto.CodeableConcept `protobuf:"bytes,25,opt,name=currency,proto3" json:"currency,omitempty"`
	Balance  []*Account_Balance                  `protobuf:"bytes,26,rep,name=balance,proto3" json:"balance,omitempty"`
	// Time the balance amount was calculated
	CalculatedAt *datatypes_go_proto.Instant `protobuf:"bytes,27,opt,name=calculated_at,json=calculatedAt,proto3" json:"calculated_at,omitempty"`
}
...
var file_proto_google_fhir_proto_r5_core_resources_account_proto_rawDesc = []byte{
	...
	0x16, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66,
	...
	0x65, 0x64, 0x75, 0x72, 0x65, 0x18, 0x17, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x67, 0x6f,
	...
	0x74, 0x18, 0x18, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	...
	0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e,
