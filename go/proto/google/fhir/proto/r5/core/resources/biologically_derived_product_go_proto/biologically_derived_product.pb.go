...
// updated 2019-12-31T21:03:40.621+11:00. A material substance originating from
...
type BiologicallyDerivedProduct_ProductCategoryCode struct {
	...
	Value     codes_go_proto.BiologicallyDerivedProductCategoryCode_Value `protobuf:"varint,1,opt,name=value,proto3,enum=google.fhir.r5.core.BiologicallyDerivedProductCategoryCode_Value" json:"value,omitempty"`
...
func (x *BiologicallyDerivedProduct_ProductCategoryCode) GetValue() codes_go_proto.BiologicallyDerivedProductCategoryCode_Value {
	...
	return codes_go_proto.BiologicallyDerivedProductCategoryCode_Value(0)
}
...
type BiologicallyDerivedProduct_StatusCode struct {
	...
	Value     codes_go_proto.ProductStatusCode_Value `protobuf:"varint,1,opt,name=value,proto3,enum=google.fhir.r5.core.ProductStatusCode_Value" json:"value,omitempty"`
	Id        *datatypes_go_proto.String             `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	Extension []*datatypes_go_proto.Extension        `protobuf:"bytes,3,rep,name=extension,proto3" json:"extension,omitempty"`
}
...
func (x *BiologicallyDerivedProduct_StatusCode) GetValue() codes_go_proto.ProductStatusCode_Value {
	if x != nil {
		return x.Value
	}
	return codes_go_proto.ProductStatusCode_Value(0)
}
...
func (*BiologicallyDerivedProduct_Collection) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 2}
}

func (x *BiologicallyDerivedProduct_Collection) GetId() *datatypes_go_proto.Id {
	if x != nil {
		return x.Id
	}
	return nil
...
func (*BiologicallyDerivedProduct_Processing) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 3}
}

func (x *BiologicallyDerivedProduct_Processing) GetId() *datatypes_go_proto.Id {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *BiologicallyDerivedProduct_Manipulation) Reset() {
	*x = BiologicallyDerivedProduct_Manipulation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BiologicallyDerivedProduct_Manipulation) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 4}
}

func (x *BiologicallyDerivedProduct_Manipulation) GetId() *datatypes_go_proto.Id {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *BiologicallyDerivedProduct_Storage) Reset() {
	*x = BiologicallyDerivedProduct_Storage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BiologicallyDerivedProduct_Storage) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 5}
}

func (x *BiologicallyDerivedProduct_Storage) GetId() *datatypes_go_proto.Id {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *BiologicallyDerivedProduct_Collection_CollectedX) Reset() {
	*x = BiologicallyDerivedProduct_Collection_CollectedX{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BiologicallyDerivedProduct_Collection_CollectedX) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 2, 0}
}
...
func (x *BiologicallyDerivedProduct_Processing_TimeX) Reset() {
	*x = BiologicallyDerivedProduct_Processing_TimeX{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BiologicallyDerivedProduct_Processing_TimeX) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 3, 0}
}
...
func (x *BiologicallyDerivedProduct_Manipulation_TimeX) Reset() {
	*x = BiologicallyDerivedProduct_Manipulation_TimeX{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BiologicallyDerivedProduct_Manipulation_TimeX) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 4, 0}
}
...
type BiologicallyDerivedProduct_Storage_ScaleCode struct {
	...
	Value     codes_go_proto.BiologicallyDerivedProductStorageScaleCode_Value `protobuf:"varint,1,opt,name=value,proto3,enum=google.fhir.r5.core.BiologicallyDerivedProductStorageScaleCode_Value" json:"value,omitempty"`
	Id        *datatypes_go_proto.String                                      `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	Extension []*datatypes_go_proto.Extension                                 `protobuf:"bytes,3,rep,name=extension,proto3" json:"extension,omitempty"`
}
...
func (x *BiologicallyDerivedProduct_Storage_ScaleCode) Reset() {
	*x = BiologicallyDerivedProduct_Storage_ScaleCode{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BiologicallyDerivedProduct_Storage_ScaleCode) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDescGZIP(), []int{0, 5, 0}
}
...
func (x *BiologicallyDerivedProduct_Storage_ScaleCode) GetValue() codes_go_proto.BiologicallyDerivedProductStorageScaleCode_Value {
	...
	return codes_go_proto.BiologicallyDerivedProductStorageScaleCode_Value(0)
}
...
var file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcf, 0x24, 0x0a, 0x1a, 0x42, 0x69, 0x6f, 0x6c,
	...
	0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x35, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x42, 0x69, 0x6f,
	...
	0x72, 0x2f, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x53, 0x65, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x2d, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0xc0, 0x9f, 0xe3, 0xb6, 0x05,
	...
	0x6f, 0x64, 0x65, 0x1a, 0xa6, 0x02, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f,
	...
	0x72, 0x35, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x53,
	...
	0x75, 0x65, 0x53, 0x65, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2d, 0x73, 0x74,
	...
	0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x63, 0x6f, 0x64, 0x65, 0x1a, 0xfe, 0x04, 0x0a,
	0x0a, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x02, 0x69,
	...
	0x6e, 0x12, 0x66, 0x0a, 0x09, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68,
	...
	0x61, 0x63, 0x74, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x52, 0x6f, 0x6c, 0x65, 0x52, 0x09,
	0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x57, 0x0a, 0x06, 0x73, 0x6f, 0x75,
	...
	,
	...
	0xe8, 0x06, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x1a, 0xf9, 0x04,
	0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x69, 0x6e, 0x67, 0x12, 0x27, 0x0a, 0x02,
	...
	0x6e, 0x12, 0x42, 0x0a, 0x09, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x64, 0x75, 0x72, 0x65, 0x18, 0x05,
	...
	0x62, 0x6c, 0x65, 0x43, 0x6f, 0x6e, 0x63, 0x65, 0x70, 0x74, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x63,
	0x65, 0x64, 0x75, 0x72, 0x65, 0x12, 0x4b, 0x0a, 0x08, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x76,
	...
	,
	...
	0x08, 0x0a, 0x06, 0x63, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x1a, 0xec, 0x03, 0x0a, 0x0c, 0x4d, 0x61,
	0x6e, 0x69, 0x70, 0x75, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x27, 0x0a, 0x02, 0x69, 0x64,
	...
	0x56, 0x0a, 0x04, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x42, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x35, 0x2e, 0x63,
	0x6f, 0x72, 0x65, 0x2e, 0x42, 0x69, 0x6f, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x61, 0x6c, 0x6c, 0x79,
	0x44, 0x65, 0x72, 0x69, 0x76, 0x65, 0x64, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x4d,
	0x61, 0x6e, 0x69, 0x70, 0x75, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x54, 0x69, 0x6d, 0x65,
	...
	0x0a, 0x06, 0x63, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x1a, 0x98, 0x06, 0x0a, 0x07, 0x53, 0x74, 0x6f,
	0x72, 0x61, 0x67, 0x65, 0x12, 0x27, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	0x68, 0x6c, 0x37, 0x2e, 0x6f, 0x72, 0x67, 0x2f, 0x66, 0x68, 0x69, 0x72, 0x2f, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x53, 0x65, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2d, 0x73, 0x74,
	0x6f, 0x72, 0x61, 0x67, 0x65, 0x2d, 0x73, 0x63, 0x61, 0x6c, 0x65, 0xc0, 0x9f, 0xe3, 0xb6, 0x05,
	0x01, 0x9a, 0xb5, 0x8e, 0x93, 0x06, 0x2c, 0x68, 0x74, 0x74, 0x70, 0x3a, 0x2f, 0x2f, 0x68, 0x6c,
	0x37, 0x2e, 0x6f, 0x72, 0x67, 0x2f, 0x66, 0x68, 0x69, 0x72, 0x2f, 0x53, 0x74, 0x72, 0x75, 0x63,
	0x74, 0x75, 0x72, 0x65, 0x44, 0x65, 0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x63,
	0x6f, 0x64, 0x65, 0x3a, 0x4e, 0xc0, 0x9f, 0xe3, 0xb6, 0x05, 0x03, 0xb2, 0xfe, 0xe4, 0x97, 0x06,
	...
	0x66, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x42, 0x69, 0x6f, 0x6c, 0x6f, 0x67, 0x69,
	0x63, 0x61, 0x6c, 0x6c, 0x79, 0x44, 0x65, 0x72, 0x69, 0x76, 0x65, 0x64, 0x50, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x42, 0x8c, 0x01, 0x98, 0xc6, 0xb0, 0xb5,
	0x07, 0x05, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66,
	0x68, 0x69, 0x72, 0x2e, 0x72, 0x35, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x50, 0x01, 0x5a, 0x69, 0x67,
...
var file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_goTypes = []interface{}{
	...
	(*BiologicallyDerivedProduct_ProductCategoryCode)(nil),               // 1: google.fhir.r5.core.BiologicallyDerivedProduct.ProductCategoryCode
	(*BiologicallyDerivedProduct_StatusCode)(nil),                        // 2: google.fhir.r5.core.BiologicallyDerivedProduct.StatusCode
	(*BiologicallyDerivedProduct_Collection)(nil),                        // 3: google.fhir.r5.core.BiologicallyDerivedProduct.Collection
	(*BiologicallyDerivedProduct_Processing)(nil),                        // 4: google.fhir.r5.core.BiologicallyDerivedProduct.Processing
	(*BiologicallyDerivedProduct_Manipulation)(nil),                      // 5: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation
	(*BiologicallyDerivedProduct_Storage)(nil),                           // 6: google.fhir.r5.core.BiologicallyDerivedProduct.Storage
	(*BiologicallyDerivedProduct_Collection_CollectedX)(nil),             // 7: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.CollectedX
	(*BiologicallyDerivedProduct_Processing_TimeX)(nil),                  // 8: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.TimeX
	(*BiologicallyDerivedProduct_Manipulation_TimeX)(nil),                // 9: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.TimeX
	(*BiologicallyDerivedProduct_Storage_ScaleCode)(nil),                 // 10: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.ScaleCode
	...
	(codes_go_proto.BiologicallyDerivedProductCategoryCode_Value)(0),     // 22: google.fhir.r5.core.BiologicallyDerivedProductCategoryCode.Value
	(*datatypes_go_proto.String)(nil),                                    // 23: google.fhir.r5.core.String
	(codes_go_proto.ProductStatusCode_Value)(0),                          // 24: google.fhir.r5.core.ProductStatusCode.Value
	...
	(codes_go_proto.BiologicallyDerivedProductStorageScaleCode_Value)(0), // 28: google.fhir.r5.core.BiologicallyDerivedProductStorageScaleCode.Value
}
var file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_depIdxs = []int32{
	11, // 0: google.fhir.r5.core.BiologicallyDerivedProduct.id:type_name -> google.fhir.r5.core.Id
	12, // 1: google.fhir.r5.core.BiologicallyDerivedProduct.meta:type_name -> google.fhir.r5.core.Meta
	13, // 2: google.fhir.r5.core.BiologicallyDerivedProduct.implicit_rules:type_name -> google.fhir.r5.core.Uri
	14, // 3: google.fhir.r5.core.BiologicallyDerivedProduct.language:type_name -> google.fhir.r5.core.Code
	15, // 4: google.fhir.r5.core.BiologicallyDerivedProduct.text:type_name -> google.fhir.r5.core.Narrative
	16, // 5: google.fhir.r5.core.BiologicallyDerivedProduct.contained:type_name -> google.protobuf.Any
	17, // 6: google.fhir.r5.core.BiologicallyDerivedProduct.extension:type_name -> google.fhir.r5.core.Extension
	17, // 7: google.fhir.r5.core.BiologicallyDerivedProduct.modifier_extension:type_name -> google.fhir.r5.core.Extension
	18, // 8: google.fhir.r5.core.BiologicallyDerivedProduct.identifier:type_name -> google.fhir.r5.core.Identifier
	1,  // 9: google.fhir.r5.core.BiologicallyDerivedProduct.product_category:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.ProductCategoryCode
	19, // 10: google.fhir.r5.core.BiologicallyDerivedProduct.product_code:type_name -> google.fhir.r5.core.CodeableConcept
	2,  // 11: google.fhir.r5.core.BiologicallyDerivedProduct.status:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.StatusCode
	20, // 12: google.fhir.r5.core.BiologicallyDerivedProduct.request:type_name -> google.fhir.r5.core.Reference
	21, // 13: google.fhir.r5.core.BiologicallyDerivedProduct.quantity:type_name -> google.fhir.r5.core.Integer
	20, // 14: google.fhir.r5.core.BiologicallyDerivedProduct.parent:type_name -> google.fhir.r5.core.Reference
	3,  // 15: google.fhir.r5.core.BiologicallyDerivedProduct.collection:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Collection
	4,  // 16: google.fhir.r5.core.BiologicallyDerivedProduct.processing:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Processing
	5,  // 17: google.fhir.r5.core.BiologicallyDerivedProduct.manipulation:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation
	6,  // 18: google.fhir.r5.core.BiologicallyDerivedProduct.storage:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Storage
	22, // 19: google.fhir.r5.core.BiologicallyDerivedProduct.ProductCategoryCode.value:type_name -> google.fhir.r5.core.BiologicallyDerivedProductCategoryCode.Value
	23, // 20: google.fhir.r5.core.BiologicallyDerivedProduct.ProductCategoryCode.id:type_name -> google.fhir.r5.core.String
	17, // 21: google.fhir.r5.core.BiologicallyDerivedProduct.ProductCategoryCode.extension:type_name -> google.fhir.r5.core.Extension
	24, // 22: google.fhir.r5.core.BiologicallyDerivedProduct.StatusCode.value:type_name -> google.fhir.r5.core.ProductStatusCode.Value
	23, // 23: google.fhir.r5.core.BiologicallyDerivedProduct.StatusCode.id:type_name -> google.fhir.r5.core.String
	17, // 24: google.fhir.r5.core.BiologicallyDerivedProduct.StatusCode.extension:type_name -> google.fhir.r5.core.Extension
	11, // 25: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.id:type_name -> google.fhir.r5.core.Id
	17, // 26: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.extension:type_name -> google.fhir.r5.core.Extension
	17, // 27: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.modifier_extension:type_name -> google.fhir.r5.core.Extension
	20, // 28: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.collector:type_name -> google.fhir.r5.core.Reference
	20, // 29: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.source:type_name -> google.fhir.r5.core.Reference
	7,  // 30: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.collected:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Collection.CollectedX
	11, // 31: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.id:type_name -> google.fhir.r5.core.Id
	17, // 32: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.extension:type_name -> google.fhir.r5.core.Extension
	17, // 33: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.modifier_extension:type_name -> google.fhir.r5.core.Extension
	23, // 34: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.description:type_name -> google.fhir.r5.core.String
	19, // 35: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.procedure:type_name -> google.fhir.r5.core.CodeableConcept
	20, // 36: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.additive:type_name -> google.fhir.r5.core.Reference
	8,  // 37: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.time:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Processing.TimeX
	11, // 38: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.id:type_name -> google.fhir.r5.core.Id
	17, // 39: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.extension:type_name -> google.fhir.r5.core.Extension
	17, // 40: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.modifier_extension:type_name -> google.fhir.r5.core.Extension
	23, // 41: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.description:type_name -> google.fhir.r5.core.String
	9,  // 42: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.time:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.TimeX
	11, // 43: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.id:type_name -> google.fhir.r5.core.Id
	17, // 44: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.extension:type_name -> google.fhir.r5.core.Extension
	17, // 45: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.modifier_extension:type_name -> google.fhir.r5.core.Extension
	23, // 46: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.description:type_name -> google.fhir.r5.core.String
	25, // 47: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.temperature:type_name -> google.fhir.r5.core.Decimal
	10, // 48: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.scale:type_name -> google.fhir.r5.core.BiologicallyDerivedProduct.Storage.ScaleCode
	26, // 49: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.duration:type_name -> google.fhir.r5.core.Period
	27, // 50: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.CollectedX.date_time:type_name -> google.fhir.r5.core.DateTime
	26, // 51: google.fhir.r5.core.BiologicallyDerivedProduct.Collection.CollectedX.period:type_name -> google.fhir.r5.core.Period
	27, // 52: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.TimeX.date_time:type_name -> google.fhir.r5.core.DateTime
	26, // 53: google.fhir.r5.core.BiologicallyDerivedProduct.Processing.TimeX.period:type_name -> google.fhir.r5.core.Period
	27, // 54: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.TimeX.date_time:type_name -> google.fhir.r5.core.DateTime
	26, // 55: google.fhir.r5.core.BiologicallyDerivedProduct.Manipulation.TimeX.period:type_name -> google.fhir.r5.core.Period
	28, // 56: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.ScaleCode.value:type_name -> google.fhir.r5.core.BiologicallyDerivedProductStorageScaleCode.Value
	23, // 57: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.ScaleCode.id:type_name -> google.fhir.r5.core.String
	17, // 58: google.fhir.r5.core.BiologicallyDerivedProduct.Storage.ScaleCode.extension:type_name -> google.fhir.r5.core.Extension
...
func file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*BiologicallyDerivedProduct_Collection_CollectedX_DateTime)(nil),
		(*BiologicallyDerivedProduct_Collection_CollectedX_Period)(nil),
	}
	file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*BiologicallyDerivedProduct_Processing_TimeX_DateTime)(nil),
		(*BiologicallyDerivedProduct_Processing_TimeX_Period)(nil),
	}
	file_proto_google_fhir_proto_r5_core_resources_biologically_derived_product_proto_msgTypes[9].OneofWrappers = []interface{}{
