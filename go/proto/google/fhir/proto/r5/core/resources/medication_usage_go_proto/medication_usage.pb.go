...
func (x *MedicationUsage) GetContained() []*anypb.Any {
	if x != nil {
		return x.Contained
	}
	return nil
...
func (x *MedicationUsage_StatusCode) GetValue() codes_go_proto.MedicationUsageStatusCode_Value {
	...
	return codes_go_proto.MedicationUsageStatusCode_Value(0)
}
...
var file_proto_google_fhir_proto_r5_core_resources_medication_usage_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2d, 0x75, 0x73, 0x61, 0x67, 0x65, 0x2d,
	...
	0x6d, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x75, 0x73, 0x61, 0x67, 0x65,
