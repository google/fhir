...
func (x *EventLabel) Reset() {
	*x = EventLabel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[0]
...
func (*EventLabel) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescGZIP(), []int{0}
}
...
func (x *EventTrigger) Reset() {
	*x = EventTrigger{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EventTrigger) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescGZIP(), []int{1}
}
...
func (x *EventLabel_Label) Reset() {
	*x = EventLabel_Label{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EventLabel_Label) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *EventLabel_Label_ClassValueX) Reset() {
	*x = EventLabel_Label_ClassValueX{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EventLabel_Label_ClassValueX) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
var file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDesc = []byte{
	0x0a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x66,
	0x68, 0x69, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x34, 0x2f, 0x6d, 0x6c, 0x5f,
	0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x11, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34,
	...
	0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x6d, 0x6c, 0x2e, 0x45, 0x76,
	...
	0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x6d, 0x6c, 0x2e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x4c,
	...
	0x65, 0x72, 0x42, 0x6c, 0x98, 0xc6, 0xb0, 0xb5, 0x07, 0x04, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x6d,
	0x6c, 0x50, 0x01, 0x5a, 0x4b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	...
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x34, 0x2f, 0x6d, 0x6c, 0x5f, 0x65, 0x78, 0x74,
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescOnce sync.Once
	file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescData = file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDesc
)

func file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescGZIP() []byte {
	file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescOnce.Do(func() {
		file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescData)
	})
	return file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDescData
}

var file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_google_fhir_proto_r4_ml_extensions_proto_goTypes = []interface{}{
	(*EventLabel)(nil),                   // 0: google.fhir.r4.ml.EventLabel
	(*EventTrigger)(nil),                 // 1: google.fhir.r4.ml.EventTrigger
	(*EventLabel_Label)(nil),             // 2: google.fhir.r4.ml.EventLabel.Label
	(*EventLabel_Label_ClassValueX)(nil), // 3: google.fhir.r4.ml.EventLabel.Label.ClassValueX
	(*datatypes_go_proto.String)(nil),    // 4: google.fhir.r4.core.String
	(*datatypes_go_proto.Extension)(nil), // 5: google.fhir.r4.core.Extension
	(*datatypes_go_proto.Reference)(nil), // 6: google.fhir.r4.core.Reference
	(*datatypes_go_proto.Coding)(nil),    // 7: google.fhir.r4.core.Coding
	...
	(*datatypes_go_proto.Decimal)(nil),   // 10: google.fhir.r4.core.Decimal
	(*datatypes_go_proto.Integer)(nil),   // 11: google.fhir.r4.core.Integer
}
var file_proto_google_fhir_proto_r4_ml_extensions_proto_depIdxs = []int32{
	4,  // 0: google.fhir.r4.ml.EventLabel.id:type_name -> google.fhir.r4.core.String
	5,  // 1: google.fhir.r4.ml.EventLabel.extension:type_name -> google.fhir.r4.core.Extension
	6,  // 2: google.fhir.r4.ml.EventLabel.patient:type_name -> google.fhir.r4.core.Reference
	7,  // 3: google.fhir.r4.ml.EventLabel.type:type_name -> google.fhir.r4.core.Coding
	8,  // 4: google.fhir.r4.ml.EventLabel.event_time:type_name -> google.fhir.r4.core.DateTime
	6,  // 5: google.fhir.r4.ml.EventLabel.source:type_name -> google.fhir.r4.core.Reference
	2,  // 6: google.fhir.r4.ml.EventLabel.label:type_name -> google.fhir.r4.ml.EventLabel.Label
	4,  // 7: google.fhir.r4.ml.EventTrigger.id:type_name -> google.fhir.r4.core.String
	7,  // 8: google.fhir.r4.ml.EventTrigger.type:type_name -> google.fhir.r4.core.Coding
	8,  // 9: google.fhir.r4.ml.EventTrigger.event_time:type_name -> google.fhir.r4.core.DateTime
	6,  // 10: google.fhir.r4.ml.EventTrigger.source:type_name -> google.fhir.r4.core.Reference
	4,  // 11: google.fhir.r4.ml.EventLabel.Label.id:type_name -> google.fhir.r4.core.String
	7,  // 12: google.fhir.r4.ml.EventLabel.Label.class_name:type_name -> google.fhir.r4.core.Coding
	3,  // 13: google.fhir.r4.ml.EventLabel.Label.class_value:type_name -> google.fhir.r4.ml.EventLabel.Label.ClassValueX
	9,  // 14: google.fhir.r4.ml.EventLabel.Label.ClassValueX.boolean:type_name -> google.fhir.r4.core.Boolean
	10, // 15: google.fhir.r4.ml.EventLabel.Label.ClassValueX.decimal:type_name -> google.fhir.r4.core.Decimal
	11, // 16: google.fhir.r4.ml.EventLabel.Label.ClassValueX.integer:type_name -> google.fhir.r4.core.Integer
	4,  // 17: google.fhir.r4.ml.EventLabel.Label.ClassValueX.string_value:type_name -> google.fhir.r4.core.String
	8,  // 18: google.fhir.r4.ml.EventLabel.Label.ClassValueX.date_time:type_name -> google.fhir.r4.core.DateTime
...
func init() { file_proto_google_fhir_proto_r4_ml_extensions_proto_init() }
func file_proto_google_fhir_proto_r4_ml_extensions_proto_init() {
	if File_proto_google_fhir_proto_r4_ml_extensions_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_google_fhir_proto_r4_ml_extensions_proto_goTypes,
		DependencyIndexes: file_proto_google_fhir_proto_r4_ml_extensions_proto_depIdxs,
		MessageInfos:      file_proto_google_fhir_proto_r4_ml_extensions_proto_msgTypes,
	}.Build()
	File_proto_google_fhir_proto_r4_ml_extensions_proto = out.File
	file_proto_google_fhir_proto_r4_ml_extensions_proto_rawDesc = nil
	file_proto_google_fhir_proto_r4_ml_extensions_proto_goTypes = nil
	file_proto_google_fhir_proto_r4_ml_extensions_proto_depIdxs = nil
}
