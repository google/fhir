...
func (x *PrimitiveProtoUnion) Reset() {
	*x = PrimitiveProtoUnion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes[0]
...
func (*PrimitiveProtoUnion) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescGZIP(), []int{0}
}
...
type PrimitiveProtoUnion_StringProto struct {
	StringProto *datatypes_go_proto.String `protobuf:"bytes,14,opt,name=string_proto,json=stringProto,proto3,oneof"`
}
...
type PrimitiveProtoUnion_Xhtml struct {
	Xhtml *datatypes_go_proto.Xhtml `protobuf:"bytes,20,opt,name=xhtml,proto3,oneof"`
}

type PrimitiveProtoUnion_Reference struct {
	Reference *datatypes_go_proto.Reference `protobuf:"bytes,21,opt,name=reference,proto3,oneof"`
}
...
func (x *ValidPair) Reset() {
	*x = ValidPair{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ValidPair) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescGZIP(), []int{1}
}
...
func (x *PrimitiveTestSuite) Reset() {
	*x = PrimitiveTestSuite{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PrimitiveTestSuite) Descriptor() ([]byte, []int) {
	return file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescGZIP(), []int{2}
}
...
var File_proto_google_fhir_proto_r4_primitive_test_suite_proto protoreflect.FileDescriptor

var file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDesc = []byte{
	0x0a, 0x35, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x66,
	0x68, 0x69, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x34, 0x2f, 0x70, 0x72, 0x69,
	...
	0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x1a,
	...
	0x22, 0xd8, 0x09, 0x0a, 0x13, 0x50, 0x72, 0x69, 0x6d, 0x69, 0x74, 0x69, 0x76, 0x65, 0x50, 0x72,
	...
	0x2e, 0x72, 0x34, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x49, 0x64, 0x48, 0x00, 0x52, 0x02, 0x69,
	...
	0x74, 0x65, 0x67, 0x65, 0x72, 0x12, 0x3b, 0x0a, 0x08, 0x6d, 0x61, 0x72, 0x6b, 0x64, 0x6f, 0x77,
	0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	...
	0x77, 0x6e, 0x12, 0x2c, 0x0a, 0x03, 0x6f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	...
	0x67, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x63,
	...
	0x0a, 0x05, 0x78, 0x68, 0x74, 0x6d, 0x6c, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x63,
	...
	0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e,
	...
	0x2e, 0x72, 0x34, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x50, 0x72, 0x69, 0x6d,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x66, 0x68, 0x69, 0x72, 0x2e, 0x72, 0x34, 0x2e, 0x74, 0x65,
	...
	0x66, 0x68, 0x69, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x72, 0x34, 0x2f, 0x70, 0x72,
...
var (
	file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescOnce sync.Once
	file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescData = file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDesc
)

func file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescGZIP() []byte {
	file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescOnce.Do(func() {
		file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescData)
	})
	return file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDescData
}

var file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_google_fhir_proto_r4_primitive_test_suite_proto_goTypes = []interface{}{
	(*PrimitiveProtoUnion)(nil),             // 0: google.fhir.r4.testing.PrimitiveProtoUnion
	(*ValidPair)(nil),                       // 1: google.fhir.r4.testing.ValidPair
	(*PrimitiveTestSuite)(nil),              // 2: google.fhir.r4.testing.PrimitiveTestSuite
	(*datatypes_go_proto.Base64Binary)(nil), // 3: google.fhir.r4.core.Base64Binary
	(*datatypes_go_proto.Boolean)(nil),      // 4: google.fhir.r4.core.Boolean
	(*datatypes_go_proto.Canonical)(nil),    // 5: google.fhir.r4.core.Canonical
	(*datatypes_go_proto.Code)(nil),         // 6: google.fhir.r4.core.Code
	(*datatypes_go_proto.Date)(nil),         // 7: google.fhir.r4.core.Date
	(*datatypes_go_proto.DateTime)(nil),     // 8: google.fhir.r4.core.DateTime
	(*datatypes_go_proto.Decimal)(nil),      // 9: google.fhir.r4.core.Decimal
	(*datatypes_go_proto.Id)(nil),           // 10: google.fhir.r4.core.Id
	(*datatypes_go_proto.Instant)(nil),      // 11: google.fhir.r4.core.Instant
	...
	(*datatypes_go_proto.Oid)(nil),          // 14: google.fhir.r4.core.Oid
	...
	(*datatypes_go_proto.Time)(nil),         // 17: google.fhir.r4.core.Time
	(*datatypes_go_proto.UnsignedInt)(nil),  // 18: google.fhir.r4.core.UnsignedInt
	(*datatypes_go_proto.Uri)(nil),          // 19: google.fhir.r4.core.Uri
	(*datatypes_go_proto.Url)(nil),          // 20: google.fhir.r4.core.Url
	(*datatypes_go_proto.Uuid)(nil),         // 21: google.fhir.r4.core.Uuid
	(*datatypes_go_proto.Xhtml)(nil),        // 22: google.fhir.r4.core.Xhtml
	(*datatypes_go_proto.Reference)(nil),    // 23: google.fhir.r4.core.Reference
}
var file_proto_google_fhir_proto_r4_primitive_test_suite_proto_depIdxs = []int32{
	3,  // 0: google.fhir.r4.testing.PrimitiveProtoUnion.base64_binary:type_name -> google.fhir.r4.core.Base64Binary
	4,  // 1: google.fhir.r4.testing.PrimitiveProtoUnion.boolean:type_name -> google.fhir.r4.core.Boolean
	5,  // 2: google.fhir.r4.testing.PrimitiveProtoUnion.canonical:type_name -> google.fhir.r4.core.Canonical
	6,  // 3: google.fhir.r4.testing.PrimitiveProtoUnion.code:type_name -> google.fhir.r4.core.Code
	7,  // 4: google.fhir.r4.testing.PrimitiveProtoUnion.date:type_name -> google.fhir.r4.core.Date
	8,  // 5: google.fhir.r4.testing.PrimitiveProtoUnion.date_time:type_name -> google.fhir.r4.core.DateTime
	9,  // 6: google.fhir.r4.testing.PrimitiveProtoUnion.decimal:type_name -> google.fhir.r4.core.Decimal
	10, // 7: google.fhir.r4.testing.PrimitiveProtoUnion.id:type_name -> google.fhir.r4.core.Id
	11, // 8: google.fhir.r4.testing.PrimitiveProtoUnion.instant:type_name -> google.fhir.r4.core.Instant
	12, // 9: google.fhir.r4.testing.PrimitiveProtoUnion.integer:type_name -> google.fhir.r4.core.Integer
	13, // 10: google.fhir.r4.testing.PrimitiveProtoUnion.markdown:type_name -> google.fhir.r4.core.Markdown
	14, // 11: google.fhir.r4.testing.PrimitiveProtoUnion.oid:type_name -> google.fhir.r4.core.Oid
	15, // 12: google.fhir.r4.testing.PrimitiveProtoUnion.positive_int:type_name -> google.fhir.r4.core.PositiveInt
	16, // 13: google.fhir.r4.testing.PrimitiveProtoUnion.string_proto:type_name -> google.fhir.r4.core.String
	17, // 14: google.fhir.r4.testing.PrimitiveProtoUnion.time:type_name -> google.fhir.r4.core.Time
	18, // 15: google.fhir.r4.testing.PrimitiveProtoUnion.unsigned_int:type_name -> google.fhir.r4.core.UnsignedInt
	19, // 16: google.fhir.r4.testing.PrimitiveProtoUnion.uri:type_name -> google.fhir.r4.core.Uri
	20, // 17: google.fhir.r4.testing.PrimitiveProtoUnion.url:type_name -> google.fhir.r4.core.Url
	21, // 18: google.fhir.r4.testing.PrimitiveProtoUnion.uuid:type_name -> google.fhir.r4.core.Uuid
	22, // 19: google.fhir.r4.testing.PrimitiveProtoUnion.xhtml:type_name -> google.fhir.r4.core.Xhtml
	23, // 20: google.fhir.r4.testing.PrimitiveProtoUnion.reference:type_name -> google.fhir.r4.core.Reference
	0,  // 21: google.fhir.r4.testing.ValidPair.proto:type_name -> google.fhir.r4.testing.PrimitiveProtoUnion
	1,  // 22: google.fhir.r4.testing.PrimitiveTestSuite.valid_pairs:type_name -> google.fhir.r4.testing.ValidPair
	0,  // 23: google.fhir.r4.testing.PrimitiveTestSuite.invalid_protos:type_name -> google.fhir.r4.testing.PrimitiveProtoUnion
...
func init() { file_proto_google_fhir_proto_r4_primitive_test_suite_proto_init() }
func file_proto_google_fhir_proto_r4_primitive_test_suite_proto_init() {
	if File_proto_google_fhir_proto_r4_primitive_test_suite_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_google_fhir_proto_r4_primitive_test_suite_proto_goTypes,
		DependencyIndexes: file_proto_google_fhir_proto_r4_primitive_test_suite_proto_depIdxs,
		MessageInfos:      file_proto_google_fhir_proto_r4_primitive_test_suite_proto_msgTypes,
	}.Build()
	File_proto_google_fhir_proto_r4_primitive_test_suite_proto = out.File
	file_proto_google_fhir_proto_r4_primitive_test_suite_proto_rawDesc = nil
	file_proto_google_fhir_proto_r4_primitive_test_suite_proto_goTypes = nil
	file_proto_google_fhir_proto_r4_primitive_test_suite_proto_depIdxs = nil
}
