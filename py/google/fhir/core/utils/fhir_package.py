...
_SearchParamaterT = TypeVar('_SearchParamaterT')
...
class FhirPackage(FhirPackageAccessor[_StructDefT, _SearchParamaterT,
  ...
  def load(
      ...
      search_param_class: Type[_SearchParamaterT],
      code_system_class: Type[_CodeSystemT],
      value_set_class: Type[_ValueSetT],
      resource_time_zone: str = 'Z'
  ) -> 'FhirPackage[_StructDefT, _SearchParamaterT, _CodeSystemT, _ValueSetT]':
    ...
    collections_per_resource_type = {
        'StructureDefinition':
            ResourceCollection[_StructDefT](struct_def_class, handler,
                                            resource_time_zone),
        'SearchParameter':
            ResourceCollection[_SearchParamaterT](search_param_class, handler,
                                                  resource_time_zone),
        'CodeSystem':
            ResourceCollection[_CodeSystemT](code_system_class, handler,
                                             resource_time_zone),
        'ValueSet':
            ResourceCollection[_ValueSetT](value_set_class, handler,
                                           resource_time_zone),
    }
  ...
  def __init__(self, *, structure_definitions: ResourceCollection[_StructDefT],
               search_parameters: ResourceCollection[_SearchParamaterT],
               code_systems: ResourceCollection[_CodeSystemT],
               value_sets: ResourceCollection[_ValueSetT]) -> None:
