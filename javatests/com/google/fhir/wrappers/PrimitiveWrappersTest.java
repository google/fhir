...
public final class PrimitiveWrappersTest {
  ...
  public PrimitiveWrappersTest(
    ...
    File file =
        new File(
            Runfiles.create()
                .rlocation(
                    "com_google_fhir/testdata/primitives/"
  ...
  public static Collection<Object[]> getParameters() {
    ...
    params.addAll(
        getParamsForVersion(
            com.google.fhir.r4.core.String.getDescriptor().getFile(),
            com.google.fhir.r4.testing.PrimitiveTestSuite.getDefaultInstance(),
            "R4"));
    params.addAll(
        getParamsForVersion(
            com.google.fhir.stu3.proto.String.getDescriptor().getFile(),
            com.google.fhir.stu3.testing.PrimitiveTestSuite.getDefaultInstance(),
            "STU3"));
    return params;
  }
