...
import com.google.fhir.r5.core.Code;
...
public class CodeWrapper extends PrimitiveWrapper<Code> {
  ...
  public static CodeWrapper of(MessageOrBuilder code) {
    ...
    if (code.hasField(idField)) {
      builder.setId((com.google.fhir.r5.core.String) code.getField(idField));
    }
  ...
  public static EnumValueDescriptor getEnumValueDescriptor(
    ...
    EnumValueDescriptor enumValue =
        enumDescriptor.findValueByName(Ascii.toUpperCase(value).replace('-', '_'));
    if (enumValue != null
