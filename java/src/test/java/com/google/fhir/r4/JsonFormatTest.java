...
import com.google.fhir.r4.proto.Account;
import com.google.fhir.r4.proto.ActivityDefinition;
import com.google.fhir.r4.proto.AdverseEvent;
import com.google.fhir.r4.proto.AllergyIntolerance;
import com.google.fhir.r4.proto.Appointment;
import com.google.fhir.r4.proto.AppointmentResponse;
import com.google.fhir.r4.proto.AuditEvent;
import com.google.fhir.r4.proto.Basic;
import com.google.fhir.r4.proto.Binary;
import com.google.fhir.r4.proto.BiologicallyDerivedProduct;
import com.google.fhir.r4.proto.BodyStructure;
import com.google.fhir.r4.proto.Bundle;
import com.google.fhir.r4.proto.CapabilityStatement;
import com.google.fhir.r4.proto.CarePlan;
import com.google.fhir.r4.proto.CareTeam;
import com.google.fhir.r4.proto.CatalogEntry;
import com.google.fhir.r4.proto.ChargeItem;
import com.google.fhir.r4.proto.ChargeItemDefinition;
import com.google.fhir.r4.proto.Claim;
import com.google.fhir.r4.proto.ClaimResponse;
import com.google.fhir.r4.proto.ClinicalImpression;
import com.google.fhir.r4.proto.Communication;
import com.google.fhir.r4.proto.CommunicationRequest;
import com.google.fhir.r4.proto.CompartmentDefinition;
import com.google.fhir.r4.proto.Composition;
import com.google.fhir.r4.proto.Condition;
import com.google.fhir.r4.proto.Consent;
import com.google.fhir.r4.proto.Contract;
import com.google.fhir.r4.proto.Coverage;
import com.google.fhir.r4.proto.CoverageEligibilityRequest;
import com.google.fhir.r4.proto.CoverageEligibilityResponse;
import com.google.fhir.r4.proto.DetectedIssue;
import com.google.fhir.r4.proto.Device;
import com.google.fhir.r4.proto.DeviceDefinition;
import com.google.fhir.r4.proto.DeviceMetric;
import com.google.fhir.r4.proto.DeviceRequest;
import com.google.fhir.r4.proto.DeviceUseStatement;
import com.google.fhir.r4.proto.DiagnosticReport;
import com.google.fhir.r4.proto.DocumentManifest;
import com.google.fhir.r4.proto.DocumentReference;
import com.google.fhir.r4.proto.EffectEvidenceSynthesis;
import com.google.fhir.r4.proto.Encounter;
import com.google.fhir.r4.proto.Endpoint;
import com.google.fhir.r4.proto.EnrollmentRequest;
import com.google.fhir.r4.proto.EnrollmentResponse;
import com.google.fhir.r4.proto.EpisodeOfCare;
import com.google.fhir.r4.proto.EventDefinition;
import com.google.fhir.r4.proto.Evidence;
import com.google.fhir.r4.proto.EvidenceVariable;
import com.google.fhir.r4.proto.ExampleScenario;
import com.google.fhir.r4.proto.ExplanationOfBenefit;
import com.google.fhir.r4.proto.FamilyMemberHistory;
import com.google.fhir.r4.proto.Flag;
import com.google.fhir.r4.proto.Goal;
import com.google.fhir.r4.proto.GraphDefinition;
import com.google.fhir.r4.proto.Group;
import com.google.fhir.r4.proto.GuidanceResponse;
import com.google.fhir.r4.proto.HealthcareService;
import com.google.fhir.r4.proto.ImagingStudy;
import com.google.fhir.r4.proto.Immunization;
import com.google.fhir.r4.proto.ImmunizationEvaluation;
import com.google.fhir.r4.proto.ImmunizationRecommendation;
import com.google.fhir.r4.proto.ImplementationGuide;
import com.google.fhir.r4.proto.InsurancePlan;
import com.google.fhir.r4.proto.Invoice;
import com.google.fhir.r4.proto.Library;
import com.google.fhir.r4.proto.Linkage;
import com.google.fhir.r4.proto.List;
import com.google.fhir.r4.proto.Location;
import com.google.fhir.r4.proto.Measure;
import com.google.fhir.r4.proto.MeasureReport;
import com.google.fhir.r4.proto.Media;
import com.google.fhir.r4.proto.Medication;
import com.google.fhir.r4.proto.MedicationAdministration;
import com.google.fhir.r4.proto.MedicationDispense;
import com.google.fhir.r4.proto.MedicationKnowledge;
import com.google.fhir.r4.proto.MedicationRequest;
import com.google.fhir.r4.proto.MedicationStatement;
import com.google.fhir.r4.proto.MedicinalProduct;
import com.google.fhir.r4.proto.MedicinalProductAuthorization;
import com.google.fhir.r4.proto.MedicinalProductContraindication;
import com.google.fhir.r4.proto.MedicinalProductIndication;
import com.google.fhir.r4.proto.MedicinalProductIngredient;
import com.google.fhir.r4.proto.MedicinalProductInteraction;
import com.google.fhir.r4.proto.MedicinalProductManufactured;
import com.google.fhir.r4.proto.MedicinalProductPackaged;
import com.google.fhir.r4.proto.MedicinalProductPharmaceutical;
import com.google.fhir.r4.proto.MedicinalProductUndesirableEffect;
import com.google.fhir.r4.proto.MessageDefinition;
import com.google.fhir.r4.proto.MessageHeader;
import com.google.fhir.r4.proto.MolecularSequence;
import com.google.fhir.r4.proto.NamingSystem;
import com.google.fhir.r4.proto.NutritionOrder;
import com.google.fhir.r4.proto.Observation;
import com.google.fhir.r4.proto.ObservationDefinition;
import com.google.fhir.r4.proto.OperationDefinition;
import com.google.fhir.r4.proto.OperationOutcome;
import com.google.fhir.r4.proto.Organization;
import com.google.fhir.r4.proto.OrganizationAffiliation;
import com.google.fhir.r4.proto.Patient;
import com.google.fhir.r4.proto.PaymentNotice;
import com.google.fhir.r4.proto.PaymentReconciliation;
import com.google.fhir.r4.proto.Person;
import com.google.fhir.r4.proto.PlanDefinition;
import com.google.fhir.r4.proto.Practitioner;
import com.google.fhir.r4.proto.PractitionerRole;
import com.google.fhir.r4.proto.Procedure;
import com.google.fhir.r4.proto.Provenance;
import com.google.fhir.r4.proto.Questionnaire;
import com.google.fhir.r4.proto.QuestionnaireResponse;
import com.google.fhir.r4.proto.RelatedPerson;
import com.google.fhir.r4.proto.RequestGroup;
import com.google.fhir.r4.proto.ResearchDefinition;
import com.google.fhir.r4.proto.ResearchElementDefinition;
import com.google.fhir.r4.proto.ResearchStudy;
import com.google.fhir.r4.proto.ResearchSubject;
import com.google.fhir.r4.proto.RiskAssessment;
import com.google.fhir.r4.proto.RiskEvidenceSynthesis;
import com.google.fhir.r4.proto.Schedule;
import com.google.fhir.r4.proto.ServiceRequest;
import com.google.fhir.r4.proto.Slot;
import com.google.fhir.r4.proto.Specimen;
import com.google.fhir.r4.proto.SpecimenDefinition;
import com.google.fhir.r4.proto.StructureMap;
import com.google.fhir.r4.proto.Subscription;
import com.google.fhir.r4.proto.Substance;
import com.google.fhir.r4.proto.SubstanceSpecification;
import com.google.fhir.r4.proto.SupplyDelivery;
import com.google.fhir.r4.proto.SupplyRequest;
import com.google.fhir.r4.proto.Task;
import com.google.fhir.r4.proto.TerminologyCapabilities;
import com.google.fhir.r4.proto.TestReport;
import com.google.fhir.r4.proto.TestScript;
import com.google.fhir.r4.proto.VerificationResult;
import com.google.fhir.r4.proto.VisionPrescription;
...
public class JsonFormatTest extends JsonFormatTestBase {
  ...
  private void generateProtoTxt(String[] fileNames, Message.Builder type) throws IOException {
    for (String fileName : fileNames) {
      ...
      File file =
          new File(
              "/google/src/cloud/nickgeorge/annotations2/com_google_fhir/testdata/r4/examples/"
                  + fileName
                  + ".prototxt");
